...
If you want to [create your own image](<docs/user-guide/using-saturn-cloud/manage-images/build-images/create-images.md>), you will need to install the GPU version of PyTorch. Conda is the easiest way to access these. Look for "CUDA" in the name, as this indicates GPU support.
