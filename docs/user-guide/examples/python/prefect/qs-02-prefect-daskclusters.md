...
[the single machine example](<docs/user-guide/examples/python/prefect/qs-01-prefect-singlenode.md>).
...
For an example of that, see [Run a Prefect Cloud Data Pipeline with access to a Dask Cluster](<docs/user-guide/examples/python/prefect/qs-03-prefect-resource-manager.md>).
