...
_Alternatively, rather than having a Dask cluster be used to train a single PyTorch model very quickly you could have the Dask cluster train many models in parallel. We have a [separate example](<docs/user-guide/examples/python/pytorch/qs-02-pytorch-gpu-dask-multiple-models.md>) for that situation._
