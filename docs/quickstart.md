...
-   [Set up your own custom resource](<docs/using-saturn-cloud/resources/jupyter-servers.md>) with your specifications by pressing one of the **New** buttons at the top.
