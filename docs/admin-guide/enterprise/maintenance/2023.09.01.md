# Upgrading to Release 2023.09.01

aliases:
  - /docs/enterprise/maintenance/2023.09.01
...
{{% enterprise-install/self-install-shell image="public.ecr.aws/saturncloud/saturn-aws:2023.09.01-19" %}}
